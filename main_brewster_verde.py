...
data = np.genfromtxt('amorfo_verde.txt', skip_header=1, delimiter='\t').transpose()
theta_amorfo = data[2]
power_amorfo = data[3]/Imax

promedio_amorfo = power_amorfo
std_amorfo = np.zeros_like(np.size(power_amorfo))
    
data = np.genfromtxt('cristalino_verde.txt', skip_header=1, delimiter='\t').transpose()
theta_cris = data[0]
# power_cris = data[1]/Imax
power_cris = (data[1]-0.8*min(data[1]))/Imax

promedio_cristalino = power_cris
std_cristalino = np.zeros_like(np.size(power_cris))
...
plt.ylabel('Reflectancia ($\lambda=532$ nm)', fontsize=18)
plt.title(r'$Sb_2S_3$ Amorfo', fontsize=18)
plt.plot(theta_amorfo, power_amorfo, 'o-', label='Medida 1')
plt.grid(None)
...
plt.plot(theta_cris, power_cris,'o-', label='Medida  1')
plt.grid(None)
plt.legend(fontsize=8)
plt.xlim([0,90])
# plt.ylim([0,1])
...
# AMORFO
plt.figure()
plt.plot(theta, 1.0*R_p_amorfo+0.0*R_s_amorfo, label = 'Simulación (100% polarización $p$)')
plt.errorbar(theta_amorfo, promedio_amorfo, yerr=std_amorfo, capsize=0, 
              fmt='none', 
              # label=r'$\langle R_{exp} \rangle \pm \sigma_{\langle R_{exp} \rangle}$ Valor medio exp.',
              color='g',
              alpha=0.1)
plt.plot(theta_amorfo, promedio_amorfo, 'g')
prom_a_f = interp1d(theta_amorfo, promedio_amorfo)
plt.plot(theta_amorfo, prom_a_f(theta_amorfo),'og', label='Experimental')
plt.grid(None)
plt.xlim([0,90])
plt.ylim([0,1])
plt.title(f'$Sb_2S_3$ Amorfo ($d={d_amorfo[0]*1e9:.0f}$ nm)', fontsize=18)
...
plt.errorbar(theta_cris, promedio_cristalino, yerr=std_cristalino, capsize=0, 
              fmt='none', 
              # label=r'$\langle R_{exp} \rangle \pm \sigma_{\langle R_{exp} \rangle}$ Valor medio exp.',
              color='g',
              alpha=0.1)
plt.plot(theta_cris, promedio_cristalino, 'g')
prom_c_f = interp1d(theta_cris, promedio_cristalino)
plt.plot(theta_cris, prom_c_f(theta_cris),'og', label='Experimental')
plt.grid(None)
plt.xlim([0,90])
plt.ylim([0,1])
plt.title(f'$Sb_2S_3$ Cristalino ($d={d_cristalino[0]*1e9:.0f}$ nm)', fontsize=18)
...
d_amorfo = np.linspace(280,280,100)*1e-9

d_cristalino = np.linspace(245,245,100)*1e-9
...
plt.xlim([0,81])
plt.ylim([0,0.3])
plt.title(f'$Sb_2S_3$ Amorfo ($\lambda=532$ nm)', fontsize=18)
plt.legend()
plt.xlabel(r"$\theta$ / grados", fontsize=18)
...
plt.xlim([0,81])
plt.ylim([0,0.3])
plt.title(f'$Sb_2S_3$ Cristalino ($\lambda=532$ nm)', fontsize=18)
plt.legend()
plt.xlabel(r"$\theta$ / grados", fontsize=18)
plt.ylabel('Reflectancia', fontsize=18)
...
prom_a_f = interp1d(theta_amorfo, promedio_amorfo)
plt.plot(theta_amorfo, prom_a_f(theta_amorfo),'-o',color=color_amorfo, label='Experimental')
plt.grid(None)
plt.xlim([0,81])
plt.ylim([0,0.3])
plt.title(f'$Sb_2S_3$ Amorfo ($\lambda=532$ nm)', fontsize=18)
...
prom_c_f = interp1d(theta_cris, promedio_cristalino)
plt.plot(theta_cris, prom_c_f(theta_cris),'-o',color=color_crist, label='Experimental')
plt.grid(None)
plt.xlim([0,81])
plt.ylim([0,0.3])
plt.title(f'$Sb_2S_3$ Cristalino ($\lambda=532$ nm)', fontsize=18)
...
for C in R_log:
    plt.plot(theta, C, 'green', alpha=0.05)

plt.plot(theta, R_log[int(np.size(d_amorfo)/2)], 'green', label='Simulación')

# GRAFICA DE CONTRASTE 

C = 10*np.log10(np.array(prom_c_f(theta_cris))/np.array(prom_a_f(theta_cris)))


plt.plot(theta_cris, C, '-ok', label='Experimental')
plt.title(f'Contraste $Sb_2S_3$ ($\lambda=532$ nm)', fontsize=18)
plt.xlabel(r"$\theta$ / grados", fontsize=18)
...
#%% GRAFICAS TEORICAS Y EXPERIMENTALES JUNTAS
...
# plt.plot(th, promedio_amorfo, 'g')
prom_a_f = interp1d(theta_amorfo, promedio_amorfo)
plt.plot(theta_amorfo, prom_a_f(theta_amorfo),'-ok',color='black', label='Experimental')
plt.xlim([0,81])
plt.ylim([0,0.3])
plt.title(f'$Sb_2S_3$ Amorfo ($\lambda=532$ nm)', fontsize=18)
plt.legend(fontsize=14)
...
# plt.plot(th, promedio_cristalino, 'g')
prom_c_f = interp1d(theta_cris, promedio_cristalino)
plt.plot(theta_cris, prom_c_f(theta_cris),'-ok',color='black', label='Experimental')
plt.xlim([0,81])
plt.ylim([0,0.3])
plt.title(f'$Sb_2S_3$ Cristalino ($\lambda=532$ nm)', fontsize=18)
plt.legend(fontsize=14)
...
#%% GRAFICAS EXPERIMENTALES ADICIONAL
...
# plt.plot(th, promedio_amorfo, 'g')
prom_a_f = interp1d(theta_amorfo, promedio_amorfo)
plt.plot(theta_amorfo, prom_a_f(theta_amorfo),'-o',color=color_amorfo, label='Medida')
plt.grid(None)
plt.xlim([0,81])
plt.ylim([0,0.3])
...
# plt.plot(th, promedio_cristalino, 'g')
prom_c_f = interp1d(theta_cris, promedio_cristalino)
plt.plot(theta_cris, prom_c_f(theta_cris),'-o',color=color_crist, label='Medida')
plt.grid(None)
plt.xlim([0,81])
plt.ylim([0,0.3])
...
T_cris = [[] for j in range(np.size(d_cristalino))]

T_amor = [[] for j in range(np.size(d_amorfo))]

A_cris = [[] for j in range(np.size(d_cristalino))]

A_amor = [[] for j in range(np.size(d_amorfo))]
...
for k in range(0,np.size(d_amorfo)):
    ...
    for i in range(0,np.size(theta)):
        ...
        R.append(stack.reflectancia(np.radians(theta[i]), landa*1e-9, pol))
        T.append(stack.transmitancia(np.radians(theta[i]), landa*1e-9, pol))

    # guardo el array de R's en el pack
    R_p_amorfo[k] = R
    T_amor[k] = T
    A_amor[k] = np.ones_like(theta) - R - T
...
for k in range(0,np.size(d_cristalino)):
    ...
    R_p_cristalino[k] = R
    T_cris[k] = T
    A_cris[k] = np.ones_like(theta) - R - T
...
for k in range(np.size(d_amorfo)):
    ...
    plt.plot(theta, R_p_amorfo[k], color=color_amorfo, alpha=0.1)
    plt.plot(theta, T_amor[k], color='royalblue', alpha=0.1)
    plt.plot(theta, A_amor[k], color='gray', alpha=0.1)

plt.plot(theta, R_p_amorfo[int(np.size(d_amorfo)/2)], color=color_amorfo, label='R')
plt.plot(theta, T_amor[int(np.size(d_amorfo)/2)], color='royalblue', label='T')
plt.plot(theta, A_amor[int(np.size(d_amorfo)/2)], color='gray', label='A')
    
plt.grid(None)
plt.xlim([0,90])
plt.ylim([0,1.0])
plt.title(f'$Sb_2S_3$ Amorfo ($\lambda={landa}$ nm)', fontsize=18)
plt.legend()
plt.xlabel(r"$\theta$ / grados", fontsize=18)
...
for k in range(np.size(d_cristalino)):
    ...
    plt.plot(theta, R_p_cristalino[k], color=color_crist, alpha=0.1)
    plt.plot(theta, T_cris[k], color='darkorange', alpha=0.1)
    plt.plot(theta, A_cris[k], color='gray', alpha=0.1)

plt.plot(theta, R_p_cristalino[int(np.size(d_cristalino)/2)], color = color_crist, label='R')
plt.plot(theta, T_cris[int(np.size(d_cristalino)/2)], color='darkorange', label='T')
plt.plot(theta, A_cris[int(np.size(d_cristalino)/2)], color='gray', label='A')

plt.grid(None)
plt.xlim([0,90])
plt.ylim([0,1.0])
plt.title(f'$Sb_2S_3$ Cristalino ($\lambda={landa}$ nm)', fontsize=18)
plt.legend()
plt.xlabel(r"$\theta$ / grados", fontsize=18)
